...
void Seeds::UseItem()
{
	...
	else if (cellData.idx == 308 && GetItemInfo()->itemId == "garlic_seeds")
	{
		if (cellData.ge == GatherableType::None) {
			SceneTest* scene = (SceneTest*)SCENE_MGR.GetCurrentScene();
			cellData.ge = GatherableType::Seed;
	...
	else if (cellData.idx == 308 && GetItemInfo()->itemId == "cauliflower_seeds")
	{
		if (cellData.ge == GatherableType::None) {
			SceneTest* scene = (SceneTest*)SCENE_MGR.GetCurrentScene();
			cellData.ge = GatherableType::Seed;
	...
	else if (cellData.idx == 308 && GetItemInfo()->itemId == "potato_seeds")
	{
		if (cellData.ge == GatherableType::None) {
			SceneTest* scene = (SceneTest*)SCENE_MGR.GetCurrentScene();
			cellData.ge = GatherableType::Seed;
